...
SYSTEM_PROMPT = """
    ...
    For every tool call wait for the onserve step which is the output from the called tool.
    ...
    - run_command(cmd: str): Takes a system command as string and executes the command on user's system and returns the output from that command.
